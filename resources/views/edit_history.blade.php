                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('history.update', $history->id) }}" method="POST">
                                            ...
                                            <div class="tab-pane fade show active" id="enfermedad" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                                <div class="row g-3">
                                                    <div class="col-md-2 mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="quantity" name="quantity" value="{{ $history->quantity }}">
                                                    ...
                                                    <div class="col-md-3 mb-2">
                                                        ...
                                                        <select class="custom-select rounded-0" id="time" name="time">
                                                            <option value="0" {{ ($history->time == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->time == 1) ? 'selected' : '' }}>Horas</option>
                                                            <option value="2" {{ ($history->time == 2) ? 'selected' : '' }}>Dias</option>
                                                            <option value="3" {{ ($history->time == 3) ? 'selected' : '' }}>Meses</option>
                                                            <option value="4" {{ ($history->time == 4) ? 'selected' : '' }}>Años</option>
                                                        </select>
                                                    </div>

                                                    <div class="col-md-7 mb-2">
                                                        <label for="reason_consultation" class="form-label">Motivo de Consulta</label>
                                                        <input type="text" class="form-control" id="reason_consultation" name="reason_consultation" value="{{ $history->reason_consultation }}">
                                                    </div>

                                                    <div class="col-md-12 mb-2">
                                                        <label for="main_symptoms" class="form-label">Relato Cronológico</label>
                                                        <textarea class="form-control" id="main_symptoms" name="main_symptoms" rows="3">{{ $history->main_symptoms }}</textarea>
                                                    </div>

                                                    <div class="col-md-2">
                                                        <label for="thirst" class="form-label">Sed</label>
                                                        <select class="custom-select rounded-0" id="thirst" name="thirst">
                                                            <option value="0" {{ ($history->thirst == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->thirst == 1) ? 'selected' : '' }}>Disminuido</option>
                                                            <option value="2" {{ ($history->thirst == 2) ? 'selected' : '' }}>Normal</option>
                                                            <option value="3" {{ ($history->thirst == 3) ? 'selected' : '' }}>Aumentado</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select rounded-0" id="appetite" name="appetite">
                                                            <option value="0" {{ ($history->appetite == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->appetite == 1) ? 'selected' : '' }}>Disminuido</option>
                                                            <option value="2" {{ ($history->appetite == 2) ? 'selected' : '' }}>Normal</option>
                                                            <option value="3" {{ ($history->appetite == 3) ? 'selected' : '' }}>Aumentado</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select rounded-0" id="dream" name="dream">
                                                            <option value="0" {{ ($history->dream == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->dream == 1) ? 'selected' : '' }}>Disminuido</option>
                                                            <option value="2" {{ ($history->dream == 2) ? 'selected' : '' }}>Normal</option>
                                                            <option value="3" {{ ($history->dream == 3) ? 'selected' : '' }}>Aumentado</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="custom-select rounded-0" id="urinary_rhythm" name="urinary_rhythm">
                                                            <option value="0" {{ ($history->urinary_rhythm == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->urinary_rhythm == 1) ? 'selected' : '' }}>Disminuido</option>
                                                            <option value="2" {{ ($history->urinary_rhythm == 2) ? 'selected' : '' }}>Normal</option>
                                                            <option value="3" {{ ($history->urinary_rhythm == 3) ? 'selected' : '' }}>Aumentado</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="custom-select rounded-0" id="evacuation_rhythm" name="evacuation_rhythm">
                                                            <option value="0" {{ ($history->evacuation_rhythm == 0) ? 'selected' : '' }}>--Seleccione--</option>
                                                            <option value="1" {{ ($history->evacuation_rhythm == 1) ? 'selected' : '' }}>Disminuido</option>
                                                            <option value="2" {{ ($history->evacuation_rhythm == 2) ? 'selected' : '' }}>Normal</option>
                                                            <option value="3" {{ ($history->evacuation_rhythm == 3) ? 'selected' : '' }}>Aumentado</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="examenes" role="tabpanel" aria-labelledby="custom-tabs-three-messages-tab">
                                                <div class="row g-3">
                                                    <div class="col-md-4 mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="heart_rate" name="heart_rate" value="{{ $history->heart_rate }}">
                                                    </div>

                                                    <div class="col-md-4 mb-2">
                                                        <label for="breathing_frequency" class="form-label">Frec. Respiratoria (por minuto)</label>
                                                        <input type="text" class="form-control" id="breathing_frequency" name="breathing_frequency" value="{{ $history->breathing_frequency }}">
                                                    </div>

                                                    <div class="col-md-4 mb-2">
                                                        <label for="blood_pressure" class="form-label">Presion Arterial (mmHg)</label>
                                                        <input type="text" class="form-control" id="blood_pressure" name="blood_pressure" value="{{ $history->blood_pressure }}">
                                                    </div>

                                                    <div class="col-md-4 mb-2">
                                                        <label for="temperature" class="form-label">Temperatura (°C)</label>
                                                        <input type="text" class="form-control" id="temperature" name="temperature" value="{{ $history->temperature }}">
                                                    </div>

                                                    <div class="col-md-2 mb-2">
                                                        <label for="weight" class="form-label">Peso (Kg)</label>
                                                        <input type="text" class="form-control" id="weight" name="weight" value="{{ $history->weight }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="imc" name="imc" value="{{ $history->imc }}" readonly>
                                                    </div>

                                                    <div class="col-md-12 mb-2">
                                                        <label for="general_exam" class="form-label">Examen General</label>
                                                        <textarea class="form-control" id="general_exam" name="general_exam" rows="3">{{ $history->general_exam }}</textarea>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <label for="preferential_exam" class="form-label">Examen Preferencial</label>
                                                        <textarea class="form-control" id="preferential_exam" name="preferential_exam" rows="3">{{ $history->preferential_exam }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="tratamientos" role="tabpanel" aria-labelledby="custom-tabs-three-settings-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mt-4">
                                                        ...
                                                        <textarea class="form-control" id="hygienic_measures" name="hygienic_measures" rows="3">{{ $history->hygienic_measures }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="observaciones" role="tabpanel" aria-labelledby="custom-tabs-three-settings-tab">
                                                <div class="row g-3">
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <textarea class="form-control" id="observations" name="observations" rows="3">{{ $history->observations }}</textarea>
                                                    </div>

                                                    <div class="col-md-4">
                                                        <label for="next_attention" class="form-label">Próxima Cita</label>
                                                        <input type="date" class="form-control" id="next_attention" name="next_attention" value="{{ $history->next_attention }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('history.index', $history->person_id) }}">
