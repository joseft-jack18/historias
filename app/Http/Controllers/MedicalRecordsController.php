...
class MedicalRecordsController extends Controller
{
    ...
    public function pdf_procedures($id)
    {
        ...
        if(count($laboratorios)){
            ...
            $mpdf->WriteHTML('<table cellspacing="0" style="width: 100%; font-size: 8px">');
            $mpdf->WriteHTML('<tr>');
            ...
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Beta 2 Microglobulina (Orina simple) </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Crioglobulinas - Sérocas </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Hepatitis delta </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:20%"><input type="radio" id="huey" name="drone" value="huey" /> Rubeola - Anticuerpos IGM </td>');
            $mpdf->WriteHTML('</tr>');

            $mpdf->WriteHTML('<tr>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> 17 Cetoesteroide </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> BK PCR </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Cryptococcus LCR - Anticuerpos </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Hepatitis - Hbe AC - Anticuerpos contra ANTE </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:20%"><input type="radio" id="huey" name="drone" value="huey" /> Sífilis (Elisa) </td>');
            $mpdf->WriteHTML('</tr>');

            /*$mpdf->WriteHTML('<tr>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Cetoesteroide </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> PCR </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Cryptococcus </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:19%"><input type="radio" id="huey" name="drone" value="huey" /> Hepatitis </td>');
            $mpdf->WriteHTML('<td style="width:1%; text-align: center"></td>');
            $mpdf->WriteHTML('<td style="width:20%"><input type="radio" id="huey" name="drone" value="huey" /> Depuracion </td>');
            $mpdf->WriteHTML('</tr>');*/
            $mpdf->WriteHTML('</table>');
